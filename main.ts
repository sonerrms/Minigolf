...
function StartLevel () {
    ...
    for (let variable3 of tiles.getTilesByType(sprites.dungeon.collectibleRedCrystal)) {
        ENEMIES = sprites.create(img`
            ...
            ........................
            `, SpriteKind.Enemy)
        tiles.placeOnTile(ENEMIES, variable3)
        tiles.setTileAt(variable3, assets.tile`transparency16`)
        animation.runImageAnimation(
        ENEMIES,
        [img`
            ........................
...
scene.onOverlapTile(SpriteKind.GolfBall, assets.tile`myTile`, function (sprite, location) {
    current_level += 1
    golfball.stopDart()
    StartLevel()
})
...
sprites.onOverlap(SpriteKind.GolfBall, SpriteKind.Coin, function (sprite, otherSprite) {
    info.changeScoreBy(1)
    otherSprite.destroy()
})
scene.onHitWall(SpriteKind.GolfBall, function (sprite, location) {
    golfball.stopDart()
})
